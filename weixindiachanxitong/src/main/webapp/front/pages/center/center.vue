    ...
    <view class="content">
        ...
        <view class="list">
              ...
              <view  @tap="onPageTap('../recharge/recharge')"
                     :style='{"backgroundColor":"#fff","borderColor":"#47EDB5","lineHeight":"80rpx","borderStyle":"solid","borderWidth":"0 0 0 60rpx"}'
                     class="li" hover-class="hover">
                  <view class="text" :style='{"color":"#47EDB5","fontSize":"28rpx"}'>用户充值</view>
