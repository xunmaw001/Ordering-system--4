	...
	<view class="uni-padding-wrap">
		...
		<view class="list" :style='{"borderRadius":0,"backgroundColor":"#efefef"}'>
			<view :style='{"borderRadius":"8rpx","backgroundColor":"#fff"}' @tap="onNewsDetailTap(item.id)"
				...
				<view class="listmr">
					<view :style='{"fontSize":"28rpx","lineHeight":"56rpx","color":"#47EDB5","textAlign":"left"}'
		...
		<view v-if='2 == 2' class="uni-product-list" :class="2 == 2 ? 'active' : ''"
			...
			<view @tap="onDetailTap('caipin',product.id)" :style='{"borderRadius":"8rpx","backgroundColor":"#fff"}'
				class="uni-product" v-for="(product,index) in caipinList" :key="index">
				<view :style='{"fontSize":"28rpx","lineHeight":"56rpx","color":"#47EDB5","textAlign":"center"}'
					class="uni-product-title">{{product.caipinName}}</view>
				<view class="image-view" :style='{"borderRadius":"2rpx","height":"180rpx"}'>
					<image :style='{"borderRadius":"2rpx","height":"180rpx"}' mode="aspectFill"
